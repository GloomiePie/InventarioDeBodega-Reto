    ...
    return (
        <View style={styles.container}>
            ...
            >
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContainer}>
                        ...
                        <Feather name="x-circle" size={90} color="#004270" />
                        <TouchableOpacity
            ...
            >
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContainer}>
                        <Text style={styles.modalTitle}>SOLICITUD ACEPTADA</Text>
                        <FontAwesome6 name="circle-check" size={90} color="#004270" style={styles.modalIcon}/>
                        <TouchableOpacity
                            style={styles.modalButton}
                            onPress={() => {
